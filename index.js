...
const SUB_PATH = process.env.SUB_PATH || '302';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '5e6ecea4-22f4-4842-9fe8-625108f42aea'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'cj302';                        // 节点名称
